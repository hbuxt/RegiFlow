...
namespace Api.Features.Users.ListMyNotifications
{
    public static class Errors
    {
        public static Error UserNotFound()
        {
            ...
            var message = "We couldn't locate your account when retrieving your notifications.";
        ...
        public static Error UserNotAuthorized()
        {
            ...
            var message = "You don't have permission to delete your view your notifications.";
        ...
        public static Error SomethingWentWrong()
        {
            ...
            var message = "An unexpected error occurred when retrieving your notifications. Please try again.";
