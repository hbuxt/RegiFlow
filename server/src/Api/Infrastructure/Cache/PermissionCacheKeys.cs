...
namespace Api.Infrastructure.Cache
{
    ...
    {
        private const string ByUser = "permissions:users:id:{0}";
        private const string ByUserInProject = "permissions:users:id:{0}:project:id:{1}";
        ...
        {
            return string.Format(ByUser, userId);
        }

        public static string ForUserInProject(Guid userId, Guid projectId)
        {
            return string.Format(ByUserInProject, userId, projectId);
        }
